...
$conn=mysqli_connect("sql100.epizy.com","epiz_31814636","QMU9Ss1Kq2","epiz_31814636_cbse_exam_guide")or die("Connection Failed");
 ...
 $sql1="select distinct(boardName)from pyq_11 order by boardName asc"; 
 $sql2="select distinct(subject) from pyq_11 order by subject asc";
 $sql3="select distinct(year) from pyq_11 order by year";
$result3=mysqli_query($conn,$sql3) or die("Query failed 3");
 ...
 ?>
        ...
        <div class="col text-center">
          ...
          <span class="px-1" id="jamiaheader">Previous Year Question Paper 11 </span>
    ...
    $sql="select *from pyq_11 where boardName='{$boardName}'and subject='{$sub}' and term='{$term}' and year='{$year}'";
